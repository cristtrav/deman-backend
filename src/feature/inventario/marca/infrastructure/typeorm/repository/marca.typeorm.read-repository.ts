...
import MARCA_FIELD_MAP from "../mapping/marca.typeorm.mapping";
...
export class MarcaTypeORMReadRepository implements MarcaReadRepository{
    ...
    async consultar(query: QueryContract): Promise<ConsultarMarcasResult> {
        const options = QueryFindOptionsMapper.toFindOptions<Marca, MarcaTypeORMModel>(query, MARCA_FIELD_MAP);
